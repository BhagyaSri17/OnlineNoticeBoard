...
if (isset($_POST['submit'])) {
    ...
    $uploads_dir = 'C:\xampp2\htdocs\MiniProject\Faculty\image';
    move_uploaded_file($tname, $uploads_dir.'/'.$pname);

    $query = mysqli_query($connect, "update faculty set
...
if (isset($_POST['update'])) {
    $update = $_POST['update'];
    $query1 = mysqli_query($connect, "select * from  faculty where id='$update'");
