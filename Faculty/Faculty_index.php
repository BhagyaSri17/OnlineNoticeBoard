...
<body>
        ...
        <div class="nav-area">
            <div class="profile-area">
                ...
                <center>
                        ...
                        echo '<h3 style="color: white; padding-bottom: 20px;">Faculty</h3> ';
                        }
                        else{
            ...
            <div class="nav-bar">
                <ul>
                    ...
                    <li>
                        <a class="navbar-link" href="studentmanagement.php"><span class="material-symbols-outlined">badge</span>Manage Student</a>
                    </li>
                   <li>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-HwwvtgBNo3bZJJLYd8oVXjrBZt8cqVSpeBNS5n7C8IVInixGAoxmnlMuBnhbgrkm" crossorigin="anonymous">
     ...
     <?php
    if (basename($_SERVER['SCRIPT_FILENAME']) === 'Faculty_index.php') {
