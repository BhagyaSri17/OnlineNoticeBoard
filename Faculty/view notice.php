...
include('dept.php');
$q = mysqli_query($connect, "select * from notice where (dept='$dept' or dept='All') and ( post='Admin' or post='HOD') and (sendto='Faculty' or  sendto='Student' or sendto='All') ORDER BY id DESC ;");
    ...
    if (isset($_POST['search'])) {
        $search = isset($_POST['search']) ? $_POST['search'] : '';
            ...
            if (strtotime($search)) {
                ...
                $fields_to_search = array('id', 'sendto', 'year', 'section', 'dept', 'postedby','post');
            ...
            $query = "SELECT * FROM notice WHERE ($where_clause) and (dept='$dept' or dept='All') and ( post='Admin' or post='HOD') and (sendto='Faculty' or  sendto='Student' or sendto='All') ORDER BY id DESC;";
