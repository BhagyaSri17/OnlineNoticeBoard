...
$q=mysqli_query($connect,"select * from notice where post='hod' and (dept='$dept' or dept='All') ORDER BY id DESC ;");
...
<select id="year" name="year" style="display: none;">
    ...
    <option value="4">4</option>
      ...
      <textarea name="description" id="textAreaField" rows="4"  cols="35" max="30" required ></textarea><br>
        <label for="file">Add File</label>
        
        <input type="file" name="file"><br>
        
        
  <button class="register" value="register" name="register">Send Notice</button>
</form>
</div>
</div>
<script>
...
<script>
    ...
    document.getElementById("back").addEventListener('click',function(){
        window.location.href="hodnotice.php";
    })
</script>
<script>
...
<script>
    ...
    var sendToSelect = document.getElementById("sendto");
