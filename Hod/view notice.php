...
include('dept.php');
$q = mysqli_query($connect, "select * from notice where  post='admin' and  (dept = '$dept' OR dept = 'All') ORDER BY id DESC ;");
    ...
    if (isset($_POST['search'])) {
        $search = isset($_POST['search']) ? $_POST['search'] : '';
            ...
            if (strtotime($search)) {
                ...
                $fields_to_search = array('id', 'year', 'section', 'postedby','post','dept');
            ...
            $query = "SELECT * FROM notice WHERE ($where_clause) AND post = 'admin' AND (dept = '$dept' OR dept = 'All') ORDER BY id DESC;";
