            ...
            <div class="nav-area">
                <div class="profile-area">
                    ...
                    <center>
                        ...
                        echo '<h3 style="color: white; padding-bottom: 20px;">Student</h3> ';
                        }
                        else{
                          echo " <img id='img' src='image/dp.png' alt='profile'>";
...
<div class="content">
    ...
    <?php
    if (basename($_SERVER['SCRIPT_FILENAME']) === 'student_index.php') {
